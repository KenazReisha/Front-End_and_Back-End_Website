...
<?php
	...
	if(isset($_POST["Simpan"])){
		...
		mysqli_query($connection, "update kategoriwisata set kategoriKODE='$kategoriKODE', kategoriNAMA='$kategoriNAMA',
    ...
    $editwisata = mysqli_query($connection, "select * from kategoriwisata where kategoriKODE = '$kodewisata'");
