...
<?php
    ...
    if(isset($_POST["edit"])){
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
        {
            ...
            mysqli_query($connection, "update destinasi set destinasiKODE = '$destinasiKODE', destinasiNAMA = '$destinasiNAMA',
            destinasiKET = '$destinasiKET', destinasiFOTO='$namafile', kategoriKODE = '$kategoriKODE'
            where destinasiKODE = '$destinasiKODE'");
        }

        mysqli_query($connection, "update destinasi set destinasiKODE = '$destinasiKODE', destinasiNAMA = '$destinasiNAMA',
        destinasiKET = '$destinasiKET', kategoriKODE = '$kategoriKODE'
        where destinasiKODE = '$destinasiKODE'");
    ...
    $editKATEGORI = mysqli_query($connection, "select * from destinasi, kategoriwisata where destinasiKODE= '$kodeDESTINASI' and destinasi.kategoriKODE = kategoriwisata.kategoriKODE");
