                    ...
                    <tbody>
                        <?php 
                            ...
                            if(isset($_POST["kirim"])){
                                $Search = $_POST["Search"];
                                $query = mysqli_query($connection, "select * from restaurant, destinasi where restaurant.destinasikode = destinasi.destinasikode AND restaurantNAMA like'%".$Search."%';");
                            } else{
                                $query = mysqli_query($connection, "select * from restaurant, destinasi where restaurant.destinasikode = destinasi.destinasikode
